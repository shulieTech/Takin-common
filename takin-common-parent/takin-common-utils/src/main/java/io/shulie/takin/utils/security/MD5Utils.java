...
public class MD5Utils {
    ...
    private String SALT = ")O[NB]6,YF}+efcaj{+oESb9d8>Z'e9M";

    /**
     * 改key
     * @param saltKey
     */
    public void changeSaltKey(String saltKey) {
        if(StringUtils.isNotBlank(saltKey)){
            this.SALT = saltKey;
        }
    }
    ...
    public static void main(String[] args) throws Exception {
        ...
        MD5Utils.getInstance().changeSaltKey("ssbb");
        String md2 = MD5Utils.getInstance().getMD5(str);
