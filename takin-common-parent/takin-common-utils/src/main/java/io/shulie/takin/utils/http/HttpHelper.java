...
public final class HttpHelper {
     ...
     * @return
     */
    public static <T> TakinResponseEntity<T> doGet(@NotNull String url, Map<String, String> headerMap,
    ...
    private static <T> TakinResponseEntity<T> get(String url, Map<String, String> headerMap, Class<T> clazz,
        ...
        return TakinResponseEntity.create(response, clazz, typeRef);
    }
     ...
     * @return
     */
    public static <T> TakinResponseEntity<T> doPost(String url, Map<String, String> headerMap, Class<T> clazz,
     ...
     * @return
     */
    public static <T> TakinResponseEntity<T> doPost(String url, Map<String, String> headerMap,
    ...
    private static <T> TakinResponseEntity<T> postJson(String url, Map<String, String> headerMap, Class<T> clazz,
        TypeReference<T> typeRef, Object requestObject) {
    ...
    public static <T> TakinResponseEntity<T> doPut(String url, Map<String, String> headerMap, Class<T> clazz,
        Object requestObject) {
        if (null == clazz || StringUtils.isEmpty(url)) {
            throw new IllegalArgumentException("url is empty or clazz is null");
        }
     ...
     * put 方法发请求 泛型
     */
    public static <T> TakinResponseEntity<T> doPut(String url, Map<String, String> headerMap,
        TypeReference<T> typeRef, Object requestObject) {
        if (null == typeRef || StringUtils.isEmpty(url)) {
            throw new IllegalArgumentException("url is empty or typeRef is null");
        }
    ...
    private static <T> TakinResponseEntity<T> putJson(String url, Map<String, String> headerMap, Class<T> clazz,
        TypeReference<T> typeRef, Object requestObject) {
        RequestBody body = RequestBody.create(JSON, JsonHelper.bean2Json(requestObject));
        Request request = new Request.Builder()
            .url(url)
    ...
    public static <T> TakinResponseEntity<T> doDelete(String url, Map<String, String> headerMap, Class<T> clazz,
        Object requestObject) {
        if (null == clazz || StringUtils.isEmpty(url)) {
            throw new IllegalArgumentException("url is empty or clazz is null");
        }
     ...
     * delete 方法发请求 泛型
     */
    public static <T> TakinResponseEntity<T> doDelete(String url, Map<String, String> headerMap,
        TypeReference<T> typeRef, Object requestObject) {
        if (null == typeRef || StringUtils.isEmpty(url)) {
            throw new IllegalArgumentException("url is empty or typeRef is null");
        }
    ...
    private static <T> TakinResponseEntity<T> deleteJson(String url, Map<String, String> headerMap, Class<T> clazz,
        TypeReference<T> typeRef, Object requestObject) {
        RequestBody body = RequestBody.create(JSON, JsonHelper.bean2Json(requestObject));
        Request request = new Request.Builder()
            .url(url)
