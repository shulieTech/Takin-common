...
public class HttpHelperTest {
    ...
    public void HttpTest() {
        ...
        //TakinResponseEntity<String> a = HttpHelper.doGet("http://127.0.0.1:8080/hessian/insertUser", String.class);
        //System.out.println("111" + a.getBody());

        Map params = Maps.newHashMap();
        params.put("pluginTypes", Lists.newArrayList("dubbo"));
        TakinResponseEntity<ResponseResult<Map<String, List<EnginePluginSimpleInfoResp>>>> result = HttpHelper.doPost(
                "http://192.168.100.135:10010/takin-cloud/open-api/engine/fetchAvailableEnginePlugins",
...
//        TakinResponseEntity<ResponseResult<SceneManageWrapperResp>> list = HttpHelper.doGet(
//            "http://localhost:10010/takin-cloud/open-api/scenemanage/detail/1",
//            getHeaders("5b06060a-17cb-4588-bb71-edd7f65035af"),
//            new TypeReference<ResponseResult<SceneManageWrapperResp>>() {});
//
//        System.out.println(list);
        //TakinResponseEntity<List<ApplicationInterfaceDTO>> list1 = HttpHelper.doGet(
    ...
    //    .1:10010/takin-cloud/api/scenemanage/ipnum/{id}",
