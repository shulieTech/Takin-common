...
/**
 * @Auther: vernon
 * @Date: 2021/8/23 04:38
 * @Description:des加解密
 */
public class DesEncryptor implements Encryptor {

    private static String strDefaultKey = "simulator";
     ...
     * @param strKey 指定的密钥
     */
    public DesEncryptor(String strKey) {
        try {
/*
...
*/
    ...
    public static void main(String[] args) throws Exception {
        Encryptor des = new DesEncryptor();
        String str = "minzhuo123453w32";
        String encode = des.encode(str);
        System.out.println(encode);

        String decode = des.decode(encode);
        System.out.println(decode);

        System.out.print(str.equals(decode));
    }
     ...
     */
    @Override
    public String encode(String code) throws Exception {
        return encrypt(code);
    }
