...
package io.shulie.takin.definition.config.zk.bean;

import java.io.Serializable;
import java.util.List;
import java.util.Map;

import io.shulie.takin.definition.config.zk.enums.ShadowDBType;
...
public class ShadowDB implements Serializable {
    ...
    public ShadowDBType getType() {
        return type;
    }

    public void setType(ShadowDBType type) {
        this.type = type;
    }
